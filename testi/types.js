      /*laitetaan järkevämmin myöhemmin */
        let types = ['accounting','airport','amusement_park','aquarium','art_gallery',
        ...
        'dentist','department_store','doctor','electrician','electronics_store','embassy','fire_station',
        ...
        'local_government_office','locksmith','lodging','mel_delivery','meal_takeaway','mosque','movie_rental',
